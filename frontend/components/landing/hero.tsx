  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Campo de búsqueda mejorado con profundidad y efecto sutil */}
        <motion.div 
        ...
        >
          <input
            ...
            className="w-full rounded-full border border-gray-300 bg-white p-5 text-lg shadow-lg 
            transition-all duration-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-300 
            focus:outline-none dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:focus:ring-blue-500"
          />
        ...
        {/* Botones con hover animado y efecto neumórfico sutil */}
        <motion.div 
        ...
        >
          <Link href="/dashboard/main">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button className="px-10 py-5 text-lg font-medium shadow-lg 
